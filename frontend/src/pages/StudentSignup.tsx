            ...
            >
                ...
                <div className="relative z-10 flex flex-col justify-center px-16 text-white h-full">
                    <div className="text-3xl font-bold mb-4 flex items-center gap-2">
                        <span className="bg-white text-green-900 p-1 rounded font-extrabold text-xl">HF</span> Hireflow
                    </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
                <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-lg border border-gray-100">
                        ...
                        <SignUp
                            ...
                            appearance={{
                                elements: {
                                    ...
                                    formFieldInput: "rounded-lg border-gray-300 focus:ring-green-500 focus:border-green-500",
                                    footerAction: "hidden"
                                }
                            }}
                        />
                    ...
                    <div className="mt-6 text-center text-sm text-gray-500">
                        Already have an account? <a href="/student-login" className="text-green-600 font-bold hover:underline">Sign in</a>
                    </div>
                </div>
            </div>
        </div>
