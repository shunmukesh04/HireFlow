...
export default function HRSignup() {
    ...
    return (
        <div className="flex h-screen w-full bg-white">
            ...
            >
                <div className="absolute inset-0 bg-gradient-to-br from-orange-900/90 to-orange-700/85"></div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
                <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-lg border border-gray-100">
                    ...
                    <div className="mt-6 text-center text-sm text-gray-500">
                        Already have an account? <a href="/hr-login" className="text-orange-600 font-bold hover:underline">Sign in</a>
                    </div>
                </div>
            </div>
        </div>
